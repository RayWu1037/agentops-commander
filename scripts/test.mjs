...
assert(readme.includes("actions/workflows/ci.yml/badge.svg"), "README shows CI badge");
assert(readme.includes("actions/workflows/pages.yml/badge.svg"), "README shows Pages badge");
assert(readme.includes("Hosted demo"), "README shows hosted demo badge/status");
...
assert(readme.includes("releases/tag/v0.1.0-submission"), "README links the submission release");
...
assert(checklist.includes("[x] Create submission-ready GitHub release snapshot"), "Championship checklist records release snapshot completion");
